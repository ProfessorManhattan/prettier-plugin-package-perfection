<!-- ⚠️ This README has been generated from the file(s) ".config/docs/blueprint-readme-plugin.md" ⚠️--><div align="center">
  <center>
    <a href="https://github.com/ProfessorManhattan/prettier-plugin-package-perfection">
...
<div align="center">
  ...
  <a href="https://github.com/ProfessorManhattan/prettier-plugin-package-perfection" title="GitHub mirror" target="_blank">
...
<div align="center">
  ...
  <a href="https://github.com/ProfessorManhattan/prettier-plugin-package-perfection/blob/master/LICENSE" target="_blank">
...
Other versions may work, but only the above versions are supported. Most development dependencies are installed automatically by our `Taskfile.yml` set-up (even Node.js and Python). Run `bash start.sh` to install **[Bodega](https://github.com/ProfessorManhattan/Bodega)** (an improved fork of [go-task](https://github.com/go-task/task)) and run the initialization sequence. The taskfiles will automatically install dependencies as they are needed, based on what development tasks you are running. For more information, check out the [CONTRIBUTING.md](https://github.com/ProfessorManhattan/prettier-plugin-package-perfection/blob/main/docs/CONTRIBUTING.md) or simply run:
